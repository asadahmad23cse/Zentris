      ...
      <Collapse
        ...
        items={[
          shouldShow(AGENT_FORM_CONFIG.basic.key) ? {
            ...
            label: `${AGENT_FORM_CONFIG.basic.title} (Required)`,
            children: (
              <>
          ...
          shouldShow(AGENT_FORM_CONFIG.skills.key) ? {
            ...
            label: `${AGENT_FORM_CONFIG.skills.title} (Required)`,
            children: (
          ...
          shouldShow(AGENT_FORM_CONFIG.capabilities.key) ? {
            ...
            label: AGENT_FORM_CONFIG.capabilities.title,
            children: (
              <>
          ...
          shouldShow(AGENT_FORM_CONFIG.optional.key) ? {
            ...
            label: AGENT_FORM_CONFIG.optional.title,
            children: (
              <>
          ...
          shouldShow(AGENT_FORM_CONFIG.Zentris.key) ? {
            key: AGENT_FORM_CONFIG.Zentris.key,
            label: AGENT_FORM_CONFIG.Zentris.title,
            children: (
              <>
