export enum VectorStoreProviders {
  ...
  PgVector = "PostgreSQL pgvector (Zentris Connector)",
  ...
  pg_vector: [
    {
      name: "api_base",
      label: "API Base",
      tooltip: "Enter the base URL of your deployed Zentris-pgvector server (e.g., http://your-server:8000)",
    ...
    },
    {
      name: "api_key",
      label: "API Key",
      tooltip: "Enter the API key from your deployed Zentris-pgvector server",
