        ...
        {step === 1 ? (
          <div className="text-center">
            ...
            <p className="text-gray-500 mb-6">
              Zentris needs access to {serverDisplayName} to complete your request.
            </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">
                    Zentris acts as a secure bridge. Your requests are routed through our MCP client directly to{" "}
